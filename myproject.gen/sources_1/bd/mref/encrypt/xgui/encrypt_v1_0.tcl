...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "m_size" -parent ${Page_0}
...
proc update_PARAM_VALUE.m_size { PARAM_VALUE.m_size } {
	# Procedure called to update m_size when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.m_size { PARAM_VALUE.m_size } {
	# Procedure called to validate m_size
	return true
}
...
proc update_MODELPARAM_VALUE.m_size { MODELPARAM_VALUE.m_size PARAM_VALUE.m_size } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.m_size}] ${MODELPARAM_VALUE.m_size}
}
